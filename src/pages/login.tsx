    ...
    <div className="min-h-screen bg-[#FAFAF8]">
      ...
      <div className="flex min-h-[calc(100vh-140px)]">
        ...
        <div className="hidden lg:block flex-1 relative overflow-hidden bg-[#0A0908]">
          <img
            src="https://images.unsplash.com/photo-1515886657613-9f3519b396dd?w=900&q=80"
            alt=""
          ...
          <div className="absolute bottom-16 left-12 right-12">
            <p className="font-cormorant text-5xl font-light text-white leading-tight mb-4">
              Dress for the<br /><em className="italic text-[#C9A84C]">life you deserve.</em>
            </p>
        ...
        <div className="flex-1 flex items-center justify-center px-6 py-16">
          ...
          >
            <div className="mb-10">
              <p className="text-[10px] tracking-[0.4em] text-[#C9A84C] font-inter uppercase mb-2">Welcome back</p>
              <h1 className="font-cormorant text-4xl font-light text-[#0A0908]">Sign In</h1>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <div className="flex justify-end">
                <Link to="/forgot-password" className="text-xs font-inter text-[#7A7571] hover:text-[#0A0908] transition-colors">
                  Forgot password?
                </Link>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full py-3.5 bg-[#0A0908] text-white text-[11px] font-inter font-medium tracking-[0.2em] hover:bg-[#C9A84C] transition-colors disabled:opacity-60 disabled:cursor-not-allowed"
              >
            ...
            <p className="mt-8 text-center text-sm font-inter text-[#7A7571]">
              ...
              <Link to="/register" className="text-[#0A0908] font-medium hover:text-[#C9A84C] transition-colors">
                Create one
              </Link>
            </p>
          </motion.div>
